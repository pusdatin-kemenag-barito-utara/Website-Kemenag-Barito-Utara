...
// SYSTEM_PROMPT — salinan persis src/lib/chat/system-prompt.js.
...
- Website ini dibangun menggunakan framework Astro (React) yang sangat cepat dan modern.
- Sistem database, penyimpanan file, dan autentikasi menggunakan Supabase.
- Backend menggunakan Golang (Fiber) dengan multi-model AI (Groq Llama, Google Gemini, Mistral, dll) agar selalu aktif 24 jam.
...
- Alamat Lengkap: Jl. Ahmad Yani No. 126, Muara Teweh, Kabupaten Barito Utara, Kalimantan Tengah 73812.
- Telepon/Fax: (0519) 123456
- WhatsApp Hotline: 0851-1749-1212
- Email Resmi: baritoutara@kemenag.go.id
- Media Sosial: Instagram @kemenag_barut, Facebook Kemenag Barito Utara.
