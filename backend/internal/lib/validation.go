...
func CleanHTML(value any, max int) string {
	...
	p.AllowElements("h1", "h2", "h3", "h4", "h5", "h6", "p", "br", "div", "ul", "ol", "li", "blockquote", "figure", "figcaption", "button", "svg", "path")
	p.AllowAttrs("data-id", "data-url", "data-filename", "data-caption", "data-date", "data-raw-date", "contenteditable").OnElements("figure")
	p.AllowAttrs("class").OnElements("figure", "figcaption", "img", "p", "div", "span", "button", "svg", "path", "a", "ul", "ol", "li", "strong", "em", "b", "i", "u", "h1", "h2", "h3", "h4")
	p.AllowStyles("text-align").Matching(regexp.MustCompile(`(?i)^(left|right|center|justify)$`)).OnElements("p", "div", "span", "h1", "h2", "h3", "h4", "h5", "h6", "blockquote", "figure", "figcaption", "table", "tr", "th", "td")
	p.AllowAttrs("align").OnElements("p", "div", "span", "h1", "h2", "h3", "h4", "h5", "h6", "blockquote", "table", "tr", "th", "td", "figure", "figcaption")
	...
	p.AllowAttrs("type", "aria-label").OnElements("button")
	p.AllowAttrs("viewBox", "fill", "stroke", "stroke-width", "stroke-linecap", "stroke-linejoin", "xmlns", "class").OnElements("svg")
	p.AllowAttrs("d", "fill-rule", "clip-rule").OnElements("path")
